...
def main():
    ...
    print("""
  ######################################
  # AAR3 Development Environment Setup #
  ######################################

  This script will create your AAR3 dev environment for you.
  ...
  This script will create two hard links on your system, both pointing to your AAR3 project folder:
    [Arma 3 installation directory]\\{} => AAR3 project folder
    P:\\{}                              => AAR3 project folder
