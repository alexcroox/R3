...
if (_isKeyFrame isEqualTo 1 || _previousVehiclePosX != _vehiclePosX || _previousVehiclePosY != _vehiclePosY || _previousVehicleHeading != _vehicleHeading || _previousCrew != _vehicleCrewString || _previousCargo != _vehicleCargoString) then {
