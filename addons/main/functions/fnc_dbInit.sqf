...
if(_version == "") exitWith { DBUG("AAR failed to load, no connection to extDB3", _functionLogName); };
...
if ((_addDatabase select 0) isEqualTo 0) exitWith { DBUG("AAR failed to connect to database, check your config", _functionLogName); };
